...
void VS1003_GPIO_conf(){
	...
	GPIO_InitStructure.Pin = XDCS_PIN;
	HAL_GPIO_Init(XDCS_PORT, &GPIO_InitStructure);

	GPIO_InitStructure.Pin = XRESET_PIN;
	HAL_GPIO_Init(XRESET_PORT, &GPIO_InitStructure);

	GPIO_InitStructure.Mode = GPIO_MODE_INPUT;
	GPIO_InitStructure.Pull = GPIO_PULLDOWN;
	GPIO_InitStructure.Pin = DREQ_PIN;
	HAL_GPIO_Init(DREQ_PORT, &GPIO_InitStructure);
...
void VS1003_SPI_conf(){
	...
	SPI_Handle.Init = SPI_InitStructure;
